...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "i", awesome.quit,
    ...
    awful.key({modkey, "Shift"}, "m", function() awful.spawn(terminal.."-e pulsemixer") end, {description = "open pulsemixer", group="apps"}),
    ...
    awful.key({modkey, "Shift"}, "s", function() awful.spawn("spectacle -r -c -b") end, {description = "screenshot area", group="apps"}),
    ...
    awful.key({modkey}, "p", function() awful.spawn("rofi -show run -theme \"Arc-Dark\" -font \"Hasklug Nerd Font 16\"") end, {description = "open rofi", group="apps"}),

    awful.key({modkey, "Shift"}, "o", function() awful.spawn("shutdown now") end, {description = "shutdown system", group="system"}),

    awful.key({modkey, "Shift"}, "p", function() awful.spawn("reboot") end, {description = "reboot system", group="system"}),

    awful.key({modkey, "Shift"}, "l", function() awful.spawn("pulsemixer") end, {description = "open pulsemixer", group="apps"}),

    awful.key({modkey}, "=", function() awful.spawn("pactl set-sink-volume @DEFAULT_SINK@ +1%") end, {description = "increase volume", group="system"}),

    awful.key({modkey}, "-", function() awful.spawn("pactl set-sink-volume @DEFAULT_SINK@ -1%") end, {description = "lower volume", group="system"}),

    awful.key({modkey}, "0", function() awful.spawn("playerctl play-pause -a") end, {description = "play-pause all players", group="system"}),
