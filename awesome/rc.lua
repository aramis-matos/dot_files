...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "p",
        ...
        { description = "open rofi", group = "apps" }),
    ...
    awful.key({ modkey }, "=", function() awful.spawn("pactl set-sink-volume @DEFAULT_SINK@ +1%") end,
        { description = "increase volume", group = "system" }),

    awful.key({ modkey }, "-", function() awful.spawn("pactl set-sink-volume @DEFAULT_SINK@ -1%") end,
        { description = "lower volume", group = "system" }),

    awful.key({ modkey }, "0", function() awful.spawn("playerctl play-pause -a") end,
        { description = "play-pause all players", group = "system" }),

    awful.key({ modkey, "Shift" }, "0", function() awful.spawn.with_shell("~/./.config/awesome/switch_sink.sh") end,
