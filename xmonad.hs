...
myKeys conf@XConfig {XMonad.modMask = modm} =
  M.fromList $
    ...
    [ ((modm .|. shiftMask, xK_Return), spawn $ XMonad.terminal conf),
      ...
      ((modm .|. shiftMask, xK_s), spawn "spectacle -r -c -b"),
      --screenshot monitor
      ((mod1Mask, xK_Print), spawn "spectacle -m -c -b"),
      --screenshot all monitors
      ((0, xK_Print), spawn "spectacle -f -c -b"),
      ...
      -- Quit xmonad
      ((modm .|. shiftMask, xK_i), io exitSuccess),
      -- shutdown
      ((modm .|. shiftMask, xK_o), spawn "shutdown now"),
      -- reboot
      ((modm .|. shiftMask, xK_p), spawn "reboot"),
      -- Restart xmonad
