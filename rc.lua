...
globalkeys = gears.table.join(
	...
	awful.key({ modkey, "Shift" }, "i", awesome.quit, { description = "quit awesome", group = "awesome" }),
	...
	awful.key({ modkey }, "`", function()
		awful.spawn.with_shell(
			"xrandr --output HDMI-0 --off --output DP-0 --off --output DP-1 --off --output DP-2 --rate 165.00 --primary --mode 2560x1440 --pos 1920x0 --rotate normal --output DP-3 --off --output DP-4 --off --output DP-5 --off"
		)
	...
	end, { description = "switch sinks", group = "system" }),
	awful.key({ modkey }, "F11", function()
		awful.spawn.with_shell("~/./.config/awesome/replay.sh")
	end, { description = "start recording", group = "system" }),
	awful.key({ modkey }, "F12", function()
		awful.spawn.with_shell("kill -INT (pidof gpu-screen-recorder)")
	end, { description = "stop recording", group = "system" }),
...
awful.spawn.with_shell("picom --experimental-backends --blur-method 'dual_kawase' --blur-strength 7 --backend 'glx' &")
